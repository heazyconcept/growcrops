                        ...
                        <div class="card-simple" data-background-image="<?php echo asset_url('img/').$crop->featured_image; ?>">
                           <div class="card-simple-background">
                              <div class="card-simple-content">
                                 <h2><a href="<?php echo base_url('earlybird/view/').$crop->slug ?>"><?php echo$crop->crop_name; ?></a></h2>
                                 ...
                                 <div class="card-simple-actions">
                                    <a href="<?php echo base_url('earlybird/view/').$crop->slug ?>" class="fa fa-search"></a>
                                 </div>
                                 <!-- /.card-simple-actions -->
                              </div>
                              <!-- /.card-simple-content -->
