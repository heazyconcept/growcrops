...
<div class="invoice">
    ...
    <div class="invoice-info">
        <div class="row">
            ...
            <div class="col-sm-4 pull-right">
                ...
                <strong>Stage Paid For:</strong> Stage <?php echo $invoice_details[0]->stage; ?><br>
            </div>
        </div>
    </div><!-- /.invoice-info -->
    <?php
    if ($manual) {
      $vat = $manual[0]->vat;
      $admin = $manual[0]->admin;
      $amount = $invoice_details[0]->amount - $vat - $admin;
      $unit_amount = $amount/$invoice_details[0]->slot;
    }else {
      $vat = $invoice_details[0]->amount * 0.02;
      $admin = ($invoice_details[0]->amount - $vat) - (2500 * $invoice_details[0]->slot);
      $amount = $invoice_details[0]->amount - $vat - $admin;
      $unit_amount = $amount/$invoice_details[0]->slot;
    }
        ...
        <tbody>
            <tr>
                <td><?php echo $invoice_details[0]->crop_name; ?></td>
                  ...
                  <td>&#8358;<?php echo number_format($unit_amount, 2); ?></td>
    ...
    <div class="invoice-summary clearfix">
        <dl class="dl-horizontal pull-right">
            ...
            <dd>&#8358;<?php echo number_format($amount, 2); ?></dd>
            <dt>VAT 5%:</dt>
            <dd>&#8358;<?php echo number_format($vat, 2); ?></dd>
            <dt>Admin Fee:</dt>
            <dd>&#8358;<?php echo number_format($admin, 2); ?></dd>
            <dt>Grand Total:</dt>
