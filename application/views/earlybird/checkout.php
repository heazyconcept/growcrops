<?php
             ...
             <table class="table table-hover mb0 checkout_table">
                 ...
                 <tbody>
                   ...
                   <tr>
                     ...
                     <td></td>
                     <td></td>
                     <td  class="final_total">&#8358;<?php echo number_format($price[0]->amount + ($price[0]->amount * 0.05), 2); ?></td>
                     <input type="hidden" id="final_total" name="" value="<?php echo $price[0]->amount + ($price[0]->amount * 0.05); ?>">
                   </tr>
                 </tbody>
             </table>
   ...
   <div class="col-sm-4">
       ...
       <div class="background-white p20">
           ...
           <div class="crop_title">
             <strong>Total Cost:</strong> <br><span class="final_total">&#8358;<?php echo number_format($price[0]->amount + ($price[0]->amount * 0.05), 2); ?></span>
           </div>
           ...
           <div class="detail-actions row">
               <div class="col-sm-5">
                   ...
                   <small>By clicking on pay, you agree you have read and agreed to the updated <a href="<?php echo base_url('home/terms_and_condition') ?>">terms and conditions.</a> </small>
               </div><!-- /.col-sm-4 -->
   ...
   $(document).ready(function () {
     $('#slot').on('keyup mouseup', function () {
       ...
       var finalAmount = totalAmount + vat;
